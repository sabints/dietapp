...
export const DietData: Array<IDishes> = [
    {
        time: "08:00:00",
        objectId: "82e6967e-65c6-4312-816d-1f085cd5ba24",
        dish: [
            {
                day: ["Mon", "Wed", "Fri", "Sun"],
                next: false,
                item:
                    [{
                        name: "Lemon Cinnamon Water",
                        unit: "1 Glass",
                    }, {
                        name: "Almonds Soaked Overnight In Water",
                        unit: "5 almonds"
                    }]
            },
            {
                ...
                next: false, item:
                    [{
                        name: "Flax Seed Water",
                        unit: "1 Glass",
                    }, {
                        name: "Walnuts Soaked Overnight in Wate",
                        unit: "2 teaspoon"
                    }]
            }
        ]
    ...
    {
        time: "08:30:00",
        objectId: "2a0e0b2d-9493-4ca5-9bc4-83d8bcfa427d",
        dish: [
            {
                day: ["Mon"],
                next: false, item:
            ...
            },
            {
                ...
                next: false, item:
                    [{
                        ...
                        name: "Egg White and Tomato Curry",
                        unit: "2 eKatori"
                    }]
            },
            {
            ...
            },
            {
                ...
                next: false, item:
                    [{
                        ...
                        name: "Green Peas Tomato Paneer Poha",
                        unit: "2 katori"
                    }]
            }
        ]
        ...
        time: "10:30:00",
        objectId: "f36cac6d-6dc9-4ec3-a216-c1cae4ad943b",
        dish: [
            {
                day: ["Mon"],
                next: false, item:
    ...
    {
        time: "13:30:00",
        objectId: "8395c35b-1840-43d5-8182-4b89461dca20",
        dish: [
            {
                day: ["Mon"],
                next: false, item:
    ...
    {
        time: "16:00:00",
        objectId: "ac8f1717-420c-452a-9a17-350a5dfcce65",
        dish: [
            {
                day: ["Mon"],
                next: false, item:
        ...
        time: "20:30:00",
        objectId: "4599614b-50cd-4a91-974b-6638c2b8d8c0",
        dish: [
            {
                day: ["Mon"],
                next: false, item:
    ...
    {
        time:"22:00:00",
        objectId:"72250ad6-f8f4-40f8-93b5-6a841b53b30e",
        dish:[ 
            {
